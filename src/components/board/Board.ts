...
export const knownOpenings: Record<string, Opening> = {
  'E4 E5 NF3 NC6 BB5': { name: 'Ruy Lopez', moves: ['e4', 'e5', 'Nf3', 'Nc6', 'Bb5'] },
  'E4 E5 NF3 NC6 BC4': { name: 'Italian Game', moves: ['e4', 'e5', 'Nf3', 'Nc6', 'Bc4'] },
  'E4 E5 NF3 NF6': { name: 'Petrov\'s Defense', moves: ['e4', 'e5', 'Nf3', 'Nf6'] },
  'D4 D5': { name: 'Queen\'s Pawn Game', moves: ['d4', 'd5'] },
  'D4 NF6 C4': { name: 'Queen\'s Pawn Opening', moves: ['d4', 'Nf6', 'c4'] },
  'D4 NF6 C4 G6 NC3 BG7': { name: 'King\'s Indian Defense', moves: ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7'] },
  ...
  'D4 NF6 C4 C5 D5 B5': { name: 'Benko Gambit', moves: ['d4', 'Nf6', 'c4', 'c5', 'd5', 'b5'] },
  'D4 NF6 C4 C5': { name: 'Benoni Defense', moves: ['d4', 'Nf6', 'c4', 'c5'] },
  'F4': { name: 'Bird\'s Opening', moves: ['f4'] },
  'D4 NF6 C4 E6 NF3 BB4': { name: 'Bogo-Indian Defense', moves: ['d4', 'Nf6', 'c4', 'e6', 'Nf3', 'Bb4'] },
  'D4 NF6 C4 E5': { name: 'Budapest Gambit', moves: ['d4', 'Nf6', 'c4', 'e5'] },
  'D4 NF6 C4 G6 NC3 D5': { name: 'Grünfeld Defense', moves: ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'd5'] },
  'D4 NF6 NF3 E6': { name: 'Colle System', moves: ['d4', 'Nf6', 'Nf3', 'e6'] },
  'D4 F5': { name: 'Dutch Defense', moves: ['d4', 'f5'] },
  'C4': { name: 'English Opening', moves: ['c4'] },
  'E4 E5 NF3 NC6 BC4 BC5 B4': { name: 'Evans Gambit', moves: ['e4', 'e5', 'Nf3', 'Nc6', 'Bc4', 'Bc5', 'b4'] },
  'E4 E5 NF3 NC6 NF3': { name: 'Four Knights Game', moves: ['e4', 'e5', 'Nf3', 'Nc6', 'Nf3'] },
  'E4 E5': { name: 'King\'s Pawn Game', moves: ['e4', 'e5'] },
  'D4 NF6 B5': { name: 'Torre Attack', moves: ['d4', 'Nf6', 'B5'] },
  'D4 NF6 C4 E6': { name: 'Queen\'s Indian Defense', moves: ['d4', 'Nf6', 'c4', 'e6'] },
  'NF3 D5 C4': { name: 'Réti Opening', moves: ['Nf3', 'd5', 'c4'] },
  'D5': { name: 'Scandinavian Defense', moves: ['d5'] },
  'E4 E5 NF3 NC6 D4': { name: 'Scotch Game', moves: ['e4', 'e5', 'Nf3', 'Nc6', 'd4'] },
  'D4 D5 C4': { name: 'Queen\'s Gambit', moves: ['d4', 'd5', 'c4'] },
  'D4 D5 C4 DXC4': { name: 'Queen\'s Gambit Accepted', moves: ['d4', 'd5', 'c4', 'dxc4'] },
  'E4 E5 NC3': { name: 'Vienna Game', moves: ['e4', 'e5', 'Nc3'] },
  'D4 D6': { name: 'Wade Defense', moves: ['d4', 'd6'] },
  'D4 NF6 C4 E6 NF3 BB4+': { name: 'Nimzo-Indian Defense', moves: ['d4', 'Nf6', 'c4', 'e6', 'Nf3', 'Bb4+'] },
  ...
  'D4 NF6 C4 G6': { name: 'King\'s Indian Attack', moves: ['d4', 'Nf6', 'c4', 'g6'] },
  'E4 E5 F4': { name: 'King\'s Gambit', moves: ['e4', 'e5', 'f4'] },
  'D4 NF6 C4 E6 G3': { name: 'Catalan Opening', moves: ['d4', 'Nf6', 'c4', 'e6', 'g3'] },
  'D4 NF6 C4 G6 NC3 BG7 E4 D6': { name: 'King\'s Indian Defense', moves: ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6'] },
};
